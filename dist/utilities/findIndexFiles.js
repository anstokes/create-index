...
var _default = function _default(directoryPath) {
  ...
  targetDirectories = _lodash.default.filter(targetDirectories, targetDirectoryPath => (0, _validateTargetDirectory.default)(_path.default.dirname(targetDirectoryPath), {

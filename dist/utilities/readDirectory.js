...
const removeDuplicates = (files, preferredExtension) => _lodash.default.filter(files, fileName => {
...
var _default = function _default(directoryPath) {
  ...
  children = _lodash.default.filter(children, fileName => {
    ...
    if (!isDirectory && !extensions.some(extension => _lodash.default.endsWith(fileName, `.${extension}`))) {
      return false;
    }

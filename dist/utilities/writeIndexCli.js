...
var _default = function _default(directoryPaths) {
  ...
  if (options.updateIndex) {
    ...
    (0, _log.default)('Semicolons:', options.noSemicolons ? _chalk.default.red('false') : _chalk.default.green('true'));
  }
  if (options.updateIndex || options.recursive) {
    sortedDirectoryPaths = _lodash.default.map(sortedDirectoryPaths, directory => (0, _findIndexFiles.default)(directory, {
  ...
  sortedDirectoryPaths = sortedDirectoryPaths.filter(directoryPath => (0, _validateTargetDirectory.default)(directoryPath, {
  ...
  _lodash.default.forEach(sortedDirectoryPaths, directoryPath => {
    ...
    const indexCode = (0, _createIndexCode.default)(directoryPath, siblings, {
